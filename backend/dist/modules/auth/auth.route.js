...
router.post("/forgot-password", identityMailRateLimit, auth_controller_1.AuthController.forgotPassword);
router.post("/reset-password", tokenVerificationRateLimit, auth_controller_1.AuthController.resetPassword);
router.post("/verify-email", tokenVerificationRateLimit, auth_controller_1.AuthController.verifyEmail);
router.post("/resend-verification", identityMailRateLimit, auth_controller_1.AuthController.resendVerification);
